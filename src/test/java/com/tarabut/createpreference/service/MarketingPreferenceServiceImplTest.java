...
import com.tarabut.createpreference.service.impl.MarketingPreferenceServiceImpl;
...
public class MarketingPreferenceServiceImplTest {
    ...
    public void shouldAbleToSaveMarketPreference() {
        ...
        // Act
        MarketingPreference serviceResponse = marketingPreferenceService.save(marketingPreference);
